...
- `2node-ngdp-service`: VALIDATED — 6/6 PASS (7m57s, 2026-07-07 sweep, fresh 2node-ngdp-service deployment). First CLAUDE.md ledger record (previously noted only as "6/6, Feb 2026" in session memory).
