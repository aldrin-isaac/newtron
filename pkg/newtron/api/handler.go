...
func (s *Server) buildMux() http.Handler {
	...
	mux.HandleFunc("GET /newtron/v1/networks/{netID}/secrets", s.handleListSecrets)
	...
	mux.HandleFunc("POST /newtron/v1/networks/{netID}/nodes/{node}/refresh-bgp", s.handleRefreshBGP)
	...
	mux.HandleFunc("GET /newtron/v1/networks/{netID}/nodes/{node}/intent/spec-diff", s.handleSpecDiff)
