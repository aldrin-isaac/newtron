...
func (s *Server) buildMux() http.Handler {
	...
	mux.HandleFunc("POST /network/{netID}/node/{device}/remove-irb", s.handleRemoveIRB)
	...
	mux.HandleFunc("POST /network/{netID}/node/{device}/add-bgp-multihop-peer", s.handleAddBGPMultihopPeer)
	mux.HandleFunc("POST /network/{netID}/node/{device}/remove-bgp-multihop-peer", s.handleRemoveBGPMultihopPeer)
