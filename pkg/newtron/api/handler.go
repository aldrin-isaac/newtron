...
func (s *Server) buildMux() http.Handler {
	...
	mux.HandleFunc("POST /network/{netID}/node/{device}/add-vlan-member", s.handleAddVLANMember)
	mux.HandleFunc("POST /network/{netID}/node/{device}/remove-vlan-member", s.handleRemoveVLANMember)
	mux.HandleFunc("POST /network/{netID}/node/{device}/configure-svi", s.handleConfigureSVI)
	...
	mux.HandleFunc("POST /network/{netID}/node/{device}/add-vrf-interface", s.handleAddVRFInterface)
	mux.HandleFunc("POST /network/{netID}/node/{device}/remove-vrf-interface", s.handleRemoveVRFInterface)
	...
	mux.HandleFunc("POST /network/{netID}/node/{device}/create-acl-table", s.handleCreateACLTable)
	mux.HandleFunc("POST /network/{netID}/node/{device}/delete-acl-table", s.handleDeleteACLTable)
	...
	mux.HandleFunc("POST /network/{netID}/node/{device}/add-overlay-peer", s.handleAddOverlayPeer)
	mux.HandleFunc("POST /network/{netID}/node/{device}/remove-overlay-peer", s.handleRemoveOverlayPeer)
	mux.HandleFunc("POST /network/{netID}/node/{device}/remove-bgp", s.handleRemoveBGP)
	...
	mux.HandleFunc("POST /network/{netID}/node/{device}/set-device-metadata", s.handleSetDeviceMetadata)
