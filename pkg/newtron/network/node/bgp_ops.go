...
// UpdateBGPEVPNPeer atomically mutates an existing EVPN overlay peer under
// the per-device intent lock — closes the EVPN session blip the
// RemoveBGPEVPNPeer + AddBGPEVPNPeer sequence exposes today. EVPN session
