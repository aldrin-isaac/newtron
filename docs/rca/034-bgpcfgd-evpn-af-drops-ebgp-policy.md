...
**Status**: Worked around (apply-frr-defaults re-run after evpn-setup)
**Component**: bgpcfgd (FRR config daemon), `newtest/suites/2node-incremental/08-evpn-setup.yaml`
