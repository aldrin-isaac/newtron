...
- `newtrun/topologies/2node-ngdp/suites/2node-ngdp-l3vpn/` — Deleted (experimental)
- `newtrun/topologies/2node-ngdp/suites/2node-ngdp-primitive/70-evpn-l3-routing.yaml` — Deleted (referenced removed actions)
