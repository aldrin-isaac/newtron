...
Spec-to-device delivery is via `POST /api/v1/network/{n}/node/{d}/intent/reconcile?mode=topology` (S11).

**Device Reads** (S7) -- all `GET /api/v1/network/{n}/node/{d}/...`
...
**Interface Operations** (S12) -- all `POST /api/v1/network/{n}/node/{d}/interface/{i}/...`
...
### POST /api/v1/network/{netID}/unregister
...
### POST /api/v1/network/{netID}/reload
...
```
POST /api/v1/network/default/reload
```
...
|----------|--------------|---------------|---------------|
| Services | `GET /api/v1/network/{netID}/service` | `GET .../service/{name}` | [`ServiceDetail`](#servicedetail) |
| IP-VPNs | `GET /api/v1/network/{netID}/ipvpn` | `GET .../ipvpn/{name}` | [`IPVPNDetail`](#ipvpndetail) |
| MAC-VPNs | `GET /api/v1/network/{netID}/macvpn` | `GET .../macvpn/{name}` | [`MACVPNDetail`](#macvpndetail) |
| QoS Policies | `GET /api/v1/network/{netID}/qos-policy` | `GET .../qos-policy/{name}` | [`QoSPolicyDetail`](#qospolicydetail) |
| Filters | `GET /api/v1/network/{netID}/filter` | `GET .../filter/{name}` | [`FilterDetail`](#filterdetail) |
| Platforms | `GET /api/v1/network/{netID}/platform` | `GET .../platform/{name}` | [`PlatformDetail`](#platformdetail) |
| Route Policies | `GET /api/v1/network/{netID}/route-policy` | `GET .../route-policy/{name}` | Route policy detail |
| Prefix Lists | `GET /api/v1/network/{netID}/prefix-list` | `GET .../prefix-list/{name}` | Prefix list detail |
| Profiles | `GET /api/v1/network/{netID}/profile` | `GET .../profile/{name}` | [`DeviceProfileDetail`](#deviceprofiledetail) |
| Zones | `GET /api/v1/network/{netID}/zone` | `GET .../zone/{name}` | [`ZoneDetail`](#zonedetail) |
...
```
GET /api/v1/network/default/service          -> {"data": [ ... array of ServiceDetail ... ]}
GET /api/v1/network/default/service/transit  -> {"data": { ... single ServiceDetail ... }}
GET /api/v1/network/default/service/missing  -> {"error": "not found: service 'missing'"}
```

#### GET /api/v1/network/{netID}/service/{name}/projection
...
```
GET /api/v1/network/default/service/TRANSIT/projection
{
  "data": {
    "service": "TRANSIT",
    "nodes": [
...
#### GET /api/v1/network/{netID}/topology
...
#### POST /api/v1/network/{netID}/topology/create-node
...
#### DELETE /api/v1/network/{netID}/topology/node/{name}
...
#### PUT /api/v1/network/{netID}/topology/node/{name}
...
#### POST /api/v1/network/{netID}/topology/create-link
...
#### DELETE /api/v1/network/{netID}/topology/link/{device}/{interface}
...
#### GET /api/v1/network/{netID}/topology/node
...
#### GET /api/v1/network/{netID}/host/{name}
...
#### GET /api/v1/network/{netID}/feature

List all features and their support status.

**Response (200):** Feature map

#### GET /api/v1/network/{netID}/feature/{name}/dependency
...
#### GET /api/v1/network/{netID}/feature/{name}/unsupported-due-to

Get the features that cause a given feature to be unsupported.

**Response (200):** Array of blocking feature strings

#### GET /api/v1/network/{netID}/platform/{name}/supports/{feature}
...
#### POST /api/v1/network/{netID}/create-service
...
```
POST /api/v1/network/default/create-service
{
  "name": "customer-l3",
  "type": "evpn-routed",
  "ipvpn": "customer-vpn",
...
#### POST /api/v1/network/{netID}/delete-service
...
#### POST /api/v1/network/{netID}/create-ipvpn
...
#### POST /api/v1/network/{netID}/delete-ipvpn
...
#### POST /api/v1/network/{netID}/create-macvpn
...
#### POST /api/v1/network/{netID}/delete-macvpn
...
#### POST /api/v1/network/{netID}/create-qos-policy
...
#### POST /api/v1/network/{netID}/delete-qos-policy
...
#### POST /api/v1/network/{netID}/add-qos-queue
...
#### POST /api/v1/network/{netID}/remove-qos-queue
...
#### POST /api/v1/network/{netID}/create-filter
...
#### POST /api/v1/network/{netID}/delete-filter
...
#### POST /api/v1/network/{netID}/add-filter-rule
...
#### POST /api/v1/network/{netID}/remove-filter-rule
...
#### POST /api/v1/network/{netID}/create-prefix-list
...
#### POST /api/v1/network/{netID}/delete-prefix-list
...
#### POST /api/v1/network/{netID}/add-prefix-list-entry
...
#### POST /api/v1/network/{netID}/remove-prefix-list-entry
...
#### POST /api/v1/network/{netID}/create-route-policy
...
#### POST /api/v1/network/{netID}/delete-route-policy
...
#### POST /api/v1/network/{netID}/add-route-policy-rule
...
#### POST /api/v1/network/{netID}/remove-route-policy-rule
...
#### POST /api/v1/network/{netID}/create-profile
...
#### POST /api/v1/network/{netID}/delete-profile
...
#### POST /api/v1/network/{netID}/create-zone
...
#### POST /api/v1/network/{netID}/delete-zone
...
1. **`POST /api/v1/network/{n}/node/{d}/init-device`** — clean factory CONFIG_DB entries
   that would conflict with newtron-managed state. Idempotent. See below.
2. **`POST /api/v1/network/{n}/node/{d}/intent/reconcile`** with `?mode=topology` — load
...
### POST /api/v1/network/{netID}/node/{device}/init-device
...
#### GET /api/v1/network/{netID}/node/{device}/info
...
#### GET /api/v1/network/{netID}/node/{device}/interface/{name}/binding
...
#### GET /api/v1/network/{netID}/node/{device}/bgp/status
...
#### GET /api/v1/network/{netID}/node/{device}/bgp/check
...
#### GET /api/v1/network/{netID}/node/{device}/evpn/status
...
#### GET /api/v1/network/{netID}/node/{device}/health
...
#### GET /api/v1/network/{netID}/node/{device}/neighbor
...
#### GET /api/v1/network/{netID}/node/{device}/route/{vrf}/{prefix...}
...
```
GET /api/v1/network/default/node/switch1/route/default/10.0.0.0/24
```

#### GET /api/v1/network/{netID}/node/{device}/route-asic/{prefix...}
...
```
GET /api/v1/network/default/node/switch1/route-asic/10.0.0.0/24
```

### Intent Tree

#### GET /api/v1/network/{netID}/node/{device}/intent/tree
...
#### POST /api/v1/network/{netID}/node/{device}/setup-device
...
```
POST /api/v1/network/default/node/switch1/setup-device
{
...
#### POST /api/v1/network/{netID}/node/{device}/create-vlan
...
```
POST /api/v1/network/default/node/switch1/create-vlan?dry_run=true
{"id": 100, "description": "Customer VLAN"}
```

#### POST /api/v1/network/{netID}/node/{device}/delete-vlan
...
#### POST /api/v1/network/{netID}/node/{device}/configure-irb
...
#### POST /api/v1/network/{netID}/node/{device}/unconfigure-irb
...
#### POST /api/v1/network/{netID}/node/{device}/create-vrf
...
#### POST /api/v1/network/{netID}/node/{device}/delete-vrf
...
#### POST /api/v1/network/{netID}/node/{device}/bind-ipvpn
...
#### POST /api/v1/network/{netID}/node/{device}/unbind-ipvpn
...
#### POST /api/v1/network/{netID}/node/{device}/bind-macvpn
...
#### POST /api/v1/network/{netID}/node/{device}/unbind-macvpn
...
#### POST /api/v1/network/{netID}/node/{device}/add-static-route
...
#### POST /api/v1/network/{netID}/node/{device}/remove-static-route
...
#### POST /api/v1/network/{netID}/node/{device}/create-acl
...
#### POST /api/v1/network/{netID}/node/{device}/delete-acl
...
#### POST /api/v1/network/{netID}/node/{device}/add-acl-rule
...
#### POST /api/v1/network/{netID}/node/{device}/remove-acl-rule
...
#### POST /api/v1/network/{netID}/node/{device}/create-portchannel
...
#### POST /api/v1/network/{netID}/node/{device}/delete-portchannel
...
#### POST /api/v1/network/{netID}/node/{device}/add-portchannel-member
...
#### POST /api/v1/network/{netID}/node/{device}/remove-portchannel-member
...
#### POST /api/v1/network/{netID}/node/{device}/add-bgp-evpn-peer
...
#### POST /api/v1/network/{netID}/node/{device}/remove-bgp-evpn-peer
...
- `POST /api/v1/network/{netID}/node/{device}/interface/{name}/apply-qos`
- `POST /api/v1/network/{netID}/node/{device}/interface/{name}/remove-qos`
...
### POST /api/v1/network/{netID}/node/{device}/reload-config
...
### POST /api/v1/network/{netID}/node/{device}/save-config
...
### POST /api/v1/network/{netID}/node/{device}/restart-daemon
...
### POST /api/v1/network/{netID}/node/{device}/ssh-command
...
### GET /api/v1/network/{netID}/node/{device}/configdb
...
### GET /api/v1/network/{netID}/node/{device}/configdb/{table}
...
### GET /api/v1/network/{netID}/node/{device}/configdb/{table}/{key}
...
```
GET /api/v1/network/default/node/switch1/configdb/VLAN/Vlan100
```

### GET /api/v1/network/{netID}/node/{device}/configdb/{table}/{key}/exists
...
### GET /api/v1/network/{netID}/node/{device}/statedb/{table}/{key}
...
#### GET /api/v1/network/{netID}/node/{device}/intent/projection
...
#### POST /api/v1/network/{netID}/node/{device}/intent/projection-diff
...
```
POST /api/v1/network/default/node/switch1/intent/projection-diff
{
  "operations": [
...
#### POST /api/v1/network/{netID}/node/{device}/interface/{name}/apply-service
...
```
POST /api/v1/network/default/node/switch1/interface/Ethernet0/apply-service
{
  "service": "customer-l3",
...
#### POST /api/v1/network/{netID}/node/{device}/interface/{name}/remove-service
...
#### POST /api/v1/network/{netID}/node/{device}/interface/{name}/refresh-service
...
#### POST /api/v1/network/{netID}/node/{device}/interface/{name}/configure-interface
...
#### POST /api/v1/network/{netID}/node/{device}/interface/{name}/unconfigure-interface
...
#### POST /api/v1/network/{netID}/node/{device}/interface/{name}/bind-acl
...
#### POST /api/v1/network/{netID}/node/{device}/interface/{name}/unbind-acl
...
- `POST /api/v1/network/{netID}/node/{device}/bind-macvpn` — see §Node-level
  Service Composition above.
- `POST /api/v1/network/{netID}/node/{device}/unbind-macvpn` — same.
...
#### POST /api/v1/network/{netID}/node/{device}/interface/{name}/add-bgp-peer
...
#### POST /api/v1/network/{netID}/node/{device}/interface/{name}/remove-bgp-peer
...
#### POST /api/v1/network/{netID}/node/{device}/interface/{name}/set-property
...
Returned in array by `GET /api/v1/network`.
