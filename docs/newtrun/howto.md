...
# 2. Start newt-server (auto-discovers all networks under networks/)
bin/newt-server &
...
|--------------|-------------|------------|
| newt-server up on `:18080` | `curl http://localhost:18080/newt-server/v1/health` | Start with `bin/newt-server &` |
